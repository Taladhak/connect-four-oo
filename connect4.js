...
class Game{
  ...
  // added makeboard function onto the class as a method
  makeBoard() {
    this.board = [];
  ...
  //  Created the board based on the HTML tags
  makeHtmlBoard() {
    ...
    // added a handleclick bound function
  ...
  // Updating DOM to place piece into HTML table of board 
  placeInTable(y, x) {
